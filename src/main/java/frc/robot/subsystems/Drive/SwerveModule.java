...
public class SwerveModule {
  ...
  public double getDrivePosition() { // Returns meters
    return driveMotor.getEncoder().getPosition() * DriveConstants.DRIVE_MOTOR_POSITION_TO_METERS;
  }

  public double getDriveVelocity() { // Returns meters per second
    return driveMotor.getEncoder().getVelocity() * DriveConstants.DRIVE_MOTOR_VELOCITY_TO_METERS_SECOND; 
  }
